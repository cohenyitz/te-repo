...
@RestController
@PreAuthorize("isAuthenticated()")  // Ask Spring to check to see if whomever wants to use any method is authorized
...
public class HotelController {
     ...
     *   
     *   An Administrators is a user with the role "ADMIN"
     */
    @PreAuthorize("hasRole('ADMIN')")       // Check to be sure authenticated use has the role 'ADMIN'
    ...
    //
    // the getName() method of the Principal class will return the name of the currently logged in user
