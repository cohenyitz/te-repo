...
--       )
--      
--       If you place the FOREIGN KEY constraint onthe CREATE TABLE, the parent table must already exist  
--          it's common to add the FOREIGN KEY constraint after all tables are created using the ALTER statement 
--          so the order of the CREATE TABLES doesn't matter      
--
