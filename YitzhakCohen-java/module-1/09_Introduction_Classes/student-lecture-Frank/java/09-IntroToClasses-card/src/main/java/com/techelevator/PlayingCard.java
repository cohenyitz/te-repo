...
public class PlayingCard {
	...
	// access data -type name; access is either public or private
	//						   public - anyone has access
	//						   private - only members of the class have access (Encapsulation) 
	
	// If you want to allow users to retrieve of change member data, you must provide methods to do so
	...
	//
	// If you want other than the Java default values for the data in our object, you need to define constructors 
	
	// a constructor has the (1) same name as the class and (2) no return type (not even void) and (3) is public
	
	public PlayingCard() {	// constructor to initialize the object to default values - called a  default constructor 
		cardValue = 8;
		cardSuit = "heart";
		cardColor = "red";
		faceUp = true;
