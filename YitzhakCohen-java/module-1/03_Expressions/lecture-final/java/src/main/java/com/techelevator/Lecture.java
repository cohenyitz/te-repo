...
public class Lecture {
    ...
    */
    public boolean returnTrueFromIf() {
        if (true) {
            return true;   // return statement ends the function/method
        }
// we only get to this line of code if the if condition is false
//    "fall out of the if" when condition is false
        return false;      // return statement ends the function/method
    }
...
//      "fall out of the if" when condition is false
    ...
    */
    public boolean returnTrueWhenGreaterThanFiveInOneLine(int number) {
        return number > 5; // the result of an expression can be return from function
    }
    ...
    */
    public String returnFizzOrBuzzOrNothing(int number) {
    	...
    	// we get only if number is not 3 and not 5
        return "";
    }
