...
public class Exercises {
	...
	public String nTwice(String str, int n) {
		String firstLast = str.substring(0, (n)) + str.substring(str.length () - n);
		return firstLast;
	...
	public String twoChar(String str, int index) {
		...
		if (str.length() % 2 == 0) {
			String lengthTwo = str.substring(index, + 2);
	...
	public boolean hasBad(String str) {
		...
		if (str.length() >= 3 && str.substring(0).startsWith(bad)) {
			System.out.println(str);
			return true;
		}
		if (str.length() >= 3 && str.substring(1).startsWith(bad)) {
			return true;
		} 
		if (str.length() >= 3 && str.substring(2).startsWith(bad)){
			return false;
		} 
			return false;
		}
	...
	public String stringYak(String str) {
		String yak = "yak";
		if (str.startsWith("yak")|| str.endsWith("yak")) {
			str.substring(str.charAt(str.indexOf("yak")));
			System.out.println(str);
		}
		return null;
	}
