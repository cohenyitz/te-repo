 ...
 */
@FixMethodOrder(MethodSorters.NAME_ASCENDING)	// List the test in alphabetical order
public class LectureTest {	// Class to hold all our JUnit tests
	...
	@Before
	public void setup() {	// method for anything to be done before each test is running 
		System.out.println("setup");	// THIS IS FOR ILLUSTRATION ONLY - IT IS NOT NORMAL TO HAVE A System.out.println() in a test
	}
	...
	public void teardown() {
		System.out.println("teardown");	// THIS IS FOR ILLUSTRATION ONLY - IT IS NOT NORMAL TO HAVE A System.out.println() in a test
	}
	 ...
	 *
	 * method-names for test should be as descriptive as possible - don't worry about naming conventions
	 *
	...
	public void length_returns_the_number_of_characters_in_a_String() {
		...
		Assert.assertEquals(4, length); 	// Assert  - Check the result and report if failure occured
	}
