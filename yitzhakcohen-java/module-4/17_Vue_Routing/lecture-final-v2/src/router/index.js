...
import AddReview      from '@/views/AddReview'     // Access AddReview.vue stuff
...
const routes = [     // Associate URL paths to router view (similar to @RequestMapping in Java Spring MVC)
     ...
     {
       path:  'product/:yitz',   // for URL /products/1  or /products/2 etc
     ...
     {
       path: '/product/:id/add-review',  // for /product/1/add-review
