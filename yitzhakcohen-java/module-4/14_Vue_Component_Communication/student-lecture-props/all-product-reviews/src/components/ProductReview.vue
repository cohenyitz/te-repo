...
export default {
  name: "product-review",
  // props is like paramaters for a Java functions: void function(datatype parameter-name)
  //                          just like a function parameter, the prop value comes from outside the component
  props: {                // props contains properties whose values come from outside the component 
    name: String,         // Specify data type expected for the property
    description: String,
    filterText: String    // value we are using to filter
  },
  data() {                // properties that are set and managed by this component 
    return {
      showForm: false,    // Specify default value for the property 
      filter: 0,
      newReview: {},
      reviews: []
    };
  ...
  computed: {
    //vm represents the Vue Model - which is all the data in this component
    //        in the initial release of Vue, it was required to accept the vm in finctions
    //        in current versions of Vue it is not
    averageRating(vm) {
