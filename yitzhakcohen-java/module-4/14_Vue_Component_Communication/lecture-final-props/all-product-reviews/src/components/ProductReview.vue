...
export default {
  name: "product-review",
  // props is like parameters for a Java function: void function(datatype parameter-name)
  //          just like a function parameter, the prop value comes form outside the component
  props: {                // props contains properties whose values come from outside the component
    ...
    description: String,
    filterText: String    // value we are using to filter our data
  },
  data() {                // properties that are set and managed by this component
    return {
      showForm: false,    // Specifiy default value for the property
      filter: 0,
      newReview: {},
      reviews: []
    };
