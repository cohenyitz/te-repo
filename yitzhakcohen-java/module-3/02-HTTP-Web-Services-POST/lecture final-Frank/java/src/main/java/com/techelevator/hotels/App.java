...
public class App {
    ...
    public static void main(String[] args) {
        int menuSelection = 999;   // Initialize to values we know are not valid
        int hotelId = -1;          // Initialize to values we know are not valid
        
// Separate functionality of User Interactions and Data Access using an API
        ConsoleService consoleService = new ConsoleService();       // Handle all user interactions
        ...
        while (menuSelection != 0) {
            ...
            if(menuSelection == 1) {
                ...
                Reservation reservation = hotelService.addReservation(newReservationString);  // We are adding code to this method
                // if unsuccessful
                if(reservation == null){
