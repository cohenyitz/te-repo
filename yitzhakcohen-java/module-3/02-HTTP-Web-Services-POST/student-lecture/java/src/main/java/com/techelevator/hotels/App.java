...
// Separate functionality of User Interactions and Data Access using API
        ...
        while (menuSelection != 0) {
            ...
            if(menuSelection == 1) {
                ...
                Reservation reservation = hotelService.addReservation(newReservationString); // We are aedding code to this method
                // if unsuccessful
                if(reservation == null){
