...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		// An ArrayList is a type of List - Used to hold a collection of object.
		// to define:
		//
		...
		// .get(index) will return the element at the index
		...
		names.add("Carl");	// It's ok to add an enter that already exists
		...
		names.add(4, "Brendan");	// add a new element at the index given - add at index 4
		...
		names.remove(names.indexOf("Frank"));	// find the index of "Frank" and use the index to remove name 
		...
		if (names.contains("Tracy")) {
			System.out.println("Found entery in ArrayList");
		}
		else {
			System.out.println("Found entery NOT in ArrayList");
		}
		...
		String [] namesArray = names.toArray(new String[names.size()]);
			...
			// 1. Ask toArry() to create an new String array with the same number f elements as the ArrayList
			// 2. Put the elements in the ArrayList into the new String array
			// 3. Return the new String array with the elements
			// 4. Assign namesArray the String array returned from to Array()
		...
		// A primitive wrapper allows you to store primitives in an ArayList
		...
		// foreach is a short hand loop for processing all elements in a Collection class
		//
		// foreach is sometimes known as "the enhanced for loop"
		//
		// foreach loop: - Always goes from the beginning to the end of the Collection 
		//				   (can't stop in the middle, can't start anywhere but the first element)
		...
		for (String anElement : names) {					// Each time through the loop anElement will contain the current element in the ArrayList
			System.out.println("Element:" + anElement);		// Display the current element (stored in the anElement0
		}
		
		int elementNumber = 0;
		
		for (String anElement : names) {					// Each time through the loop anElement will contain the current element in the ArrayList
			System.out.println("Element #"+ elementNumber + ": " + anElement);		// Display the current element (stored in the anElement0
			elementNumber++;
		}
