...
// provides a generic or basic version of an object
...
public abstract class PlayingCard {
	...
	// An asbstract class may have methods with bodies that do processing
	...
	// An abstract method MUST be defined by any sub class of this class
	// The purpose of an abstract method is to require the behavior without defining it
	// A sub-class must override a super-class abstract method
