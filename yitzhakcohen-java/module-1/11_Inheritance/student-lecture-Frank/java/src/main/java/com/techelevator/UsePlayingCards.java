...
public class UsePlayingCards {
	...
	// 	This is an application program because it has a main() method
	//	An application program instantiates object and uses the object to do work

	public static void main(String[] args) {
		
		ItalianPlayingCard mario = new ItalianPlayingCard(); // Instantiate an ItalianPlayingCard
		System.out.println("Mario is:" + mario);	// The PlayingCard toString() method is used
		
		ItalianPlayingCard luigi = new ItalianPlayingCard(); // Instantiate an ItalianPlayingCard
		System.out.println("Luigi is:" + luigi);
		System.out.println("Mario and Luigi:" + mario.equals(luigi)); // The PlayingCard equals() is used
